            ...
            <div class="modal-body">
                <div class="row u-s-m-x-0">
                    <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                        ...
                        <img class="u-img-fluid u-d-block" src="{{ asset('front/images/newsletter/subscribe-now.png') }}" alt=""></a>
                    </div>
                    <div class="col-lg-6 new-l__col-2">
                        <div class="new-l__section u-s-m-t-30">
                            ...
                            <div class="u-s-m-b-30 new-l--center">
                                <p class="new-l__p1">Subscribe for emails to get the scoop on new arrivals, special sales and more.</p>
                            </div>

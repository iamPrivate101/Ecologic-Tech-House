                    ...
                    <div class="pd u-s-m-b-30">
                        <div class="slider-fouc pd-wrap">
                            <div id="pd-o-initiate">
                                ...
                                <div class="pd-o-img-wrap" data-src="{{ asset('front/images/products/large/'.$image['image']) }}">
                                    <img class="u-img-fluid" src="{{ asset('front/images/products/large/'.$image['image']) }}" data-zoom-image="{{ asset('front/images/products/large/'.$image['image']) }}" alt="{{ $productDetails['product_name'] }}">
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="u-s-m-t-15">
                            <div class="slider-fouc">
                                ...
                                @foreach ($productDetails['images'] as $image )
                                    <div>
                                        <img class="u-img-fluid" src="{{ asset('front/images/products/small/'.$image['image']) }}" alt="{{ $productDetails['product_name'] }}">
                                    </div>
                                @endforeach
                                </div>
                            </div>
                                        ...
                                        <div class="pd-table gl-scroll">
                                            <table>
                                                <tbody>
                                                    ...
                                                    @if(!empty($productDetails['laptop']))
                                                    <tr>
                                                        <td>Laptop</td>
                                                        <td>{{ $productDetails['laptop'] }}</td>
                                                    </tr>
                                                    @endif
                                                    @if(!empty($productDetails['computer']))
                                                    <tr>
                                                        <td>Computer</td>
                                                        <td>{{ $productDetails['computer'] }}</td>
                                                    </tr>
                                                    @endif
                                                    @if(!empty($productDetails['mobile']))
                                                    <tr>
                                                        <td>Mobile</td>
                                                        <td>{{ $productDetails['mobile'] }}</td>
                                                    </tr>
                                                    @endif
                                                    @if(!empty($productDetails['network']))
                                                    <tr>
                                                        <td>Network</td>
                                                        <td>{{ $productDetails['network'] }}</td>
                                                    </tr>
                                                    @endif
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section__text-wrap">
                            <h1 class="section__heading u-c-secondary u-s-m-b-12">RECOMMENDED PRODUCTS</h1>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="{{ url('product/'.$product['id']) }}">
                                        ...
                                        <img class="aspect__img" src="{{ asset('front/images/products/medium/'.$product['images'][0]['image']) }}" alt="{{ $product['product_name'] }}">
                                        @else
                                        <img class="aspect__img" src="{{ asset('front/images/product/sitemakers-tshirt.png') }}" alt="{{ $product['product_name'] }}">
                                        @endif
                                    </a>
                                </div>
                                ...
                                <span class="product-o__price">Rs {{ $product['final_price'] }}

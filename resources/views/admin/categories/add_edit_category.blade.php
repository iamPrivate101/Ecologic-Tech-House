                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="meta_title" id="meta_title"
                                                placeholder="Enter Category Meta Title"  value="{{ old('meta_title') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="meta_keywords"
                                                id="meta_keywords" placeholder="Enter Category Meta Keywords"  value="{{ old('meta_keywords') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="meta_description"
                                                id="meta_description" placeholder="Enter Category Meta Description"  value="{{ old('meta_description') }}"
